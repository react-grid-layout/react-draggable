	...
	module.exports = React.createClass({
		...
		handleDragStart: function (e) {
			...
			this.setState({
				...
				checkFirstMove: this.props.axis !== 'both'
			});
		...
		handleDrag: function (e) {
			...
			// For one-axis drags, decide if the user wanted to drag or if we should abort
			if (this.state.checkFirstMove) {
				var absX = Math.abs(dragPoint.clientX - this.state.offsetX), absY = Math.abs(dragPoint.clientY - this.state.offsetY);
				if ((this.props.axis === 'x' && absY > absX) || (this.props.axis === 'y' && absX > absY)) {
