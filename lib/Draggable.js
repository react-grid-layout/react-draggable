...
import type {ControlPosition, InitialControlPosition, DraggableBounds, DraggableCoreProps} from './DraggableCore';
...
export type DraggableProps = {
  ...
  initialPosition: InitialControlPosition,
...
export default class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  render(): ReactElement<any> {
    ...
    if (this.state.isElementSVG) {
      svgTransform = createSVGTransform(transformOpts, this.props.initialPosition);
    } else {
      // Add a CSS transform to move the element around. This allows us to move the element around
      // without worrying about whether or not it is relatively or absolutely positioned.
      // If the item you are dragging already has a transform set, wrap it in a <span> so <Draggable>
      // has a clean slate.
      style = createCSSTransform(transformOpts, this.props.initialPosition);
    }
