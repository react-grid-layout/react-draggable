...
module.exports = React.createClass({
	...
	handleMouseMove: function (e) {
		...
		if (e.type === "touchmove") {
			var clientX = (this.state.startX + (e.touches[0].clientX - this.state.offsetX));
			var clientY = (this.state.startY + (e.touches[0].clientY - this.state.offsetY));
			console.log(this.state.startX, e.touches[0].clientX, this.state.offsetX);
		} else {
