...
module.exports = React.createClass({
  ...
  componentDidMount: function() {
    var observable = this.props.scrollableAncestor;
    ...
    this.setState({
      scroll: {
        ...
        measure: observable === document ? document.body : observable
      }
    })
  },

  getScrollAmount: function() {
    var scroll = this.state.scroll.measure;
    return {
      x: scroll.scrollLeft,
      y: scroll.scrollTop
    };
  ...
  handleDragStart: function (e) {
    ...
    var scroll = this.getScrollAmount();
    ...
    // Add event handlers
    addEvent(this.state.scroll.observable, 'scroll', this.handleScroll);
  ...
  handleDragEnd: function (e) {
    ...
    removeEvent(this.state.scroll.observable, 'scroll', this.handleScroll);
    removeEvent(document, dragEventFor.move, this.handleDrag);
    removeEvent(document, dragEventFor.end, this.handleDragEnd);
  },
  ...
  handleScroll: function(e) {
    var s = this.state, scroll = this.getScrollAmount(), x = scroll.x, y = scroll.y,
        offsetX = x - s.scrollX, offsetY = y - s.scrollY;
    this.setState({
      scrollX: x,
      scrollY: y,
