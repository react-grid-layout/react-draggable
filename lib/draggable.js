...
function disableChildImagesDraggable(el) {
...
module.exports = React.createClass({
  ...
  propTypes: {
    ...
    /**
     * Set `disableImgDraggable` to true to automatically set draggable="false"
     * on all child img elements on mount. This prevents the browser from hijacking
     * the drag of the images so that they behave as expected with Draggable.
     */
    disableImgDraggable: React.PropTypes.bool
  },

  componentDidMount: function() {
    // Set draggable=false on any img children.
    if (this.props.disableImgDraggable) {
      disableChildImagesDraggable(this.getDOMNode());
    }
  },
