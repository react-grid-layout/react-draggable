...
export function addUserSelectStyles(doc: HTMLElement) {
  ...
  if (!isChrome) {
    ...
    doc.body.setAttribute('style', style + userSelectStyle);
  }
  else {
...
export function removeUserSelectStyles(doc: HTMLElement) {
  const style = body.getAttribute('style') || '';
  doc.body.setAttribute('style', style.replace(userSelectReplaceRegExp, ''));
  doc.body.classList && body.classList.remove('react-draggable-transparent-selection');
}
